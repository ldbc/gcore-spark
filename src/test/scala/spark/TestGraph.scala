...
case class Cat(id: Int, name: String, age: Double, weight: Int, onDiet: Boolean)
case class Food(id: Int, brand: String)
case class Country(id: Int, name: String)
case class Eats(id: Int, gramsPerDay: Double, fromId: Int, toId: Int)
case class Friend(id: Int, since: String, fromId: Int, toId: Int)
case class Enemy(id: Int, since: String, fights: Int, fromId: Int, toId: Int)
...
case class CatFood(catId: Int, name: String, age: Double, weight: Int, onDiet: Boolean,
                   foodId: Int, brand: String)
case class CatToGourmandFood(catId: Int, name: String, age: Double, weight: Int, onDiet: Boolean,
                             foodId: Int, brand: String,
                             toGourmandId: Int, hops: Int, fromId: Int, toId: Int, edges: Seq[Int],
                             cost: Int)
case class FoodMadeInCountry(foodId: Int, brand: String,
                             countryId: Int, name: String,
                             madeInId: Int, fromId: Int, toId: Int)
case class FoodCountry(foodId: Int, brand: String, countryId: Int, name: String)
