...
import planner.target_api.{BindingTable, PhysProject}
import planner.trees.TargetTreeNode

case class SparkProject(relation: TargetTreeNode, attributes: Seq[Reference])
  extends PhysProject(relation, attributes) {
